...
function authorityManage() {
    var title = '权限管理';
    var c = '<table id="workGridAuthority" class="easyui-datagrid" data-options="url:\'getAuthority/\', toolbar:\'#workGridToolBarAuthority\', singleSelect:true, fitColumns:true, rownumbers:true, loadMsg:\'作业数据正在载入，请稍后...\', pagination:true, fit:true, pageSize:20">' +
        '<thead>' +
        '<tr>' +
        '<th align="center" rowspan="2" colspan="3" align="center">用户</th>' +
        '<th align="center" colspan="12">岗位权限&nbsp;&nbsp;(<img src="' + $('#okStatus').attr('value') + '">拥有权限</img>&nbsp;&nbsp;&nbsp;&nbsp;<img src="' + $('#noStatus').attr('value') + '">未拥有权限</img>)</th>' +
        '</tr>' +
        '<tr>' +
        '<th align="center" colspan="2" width="40">实物分发</th><th align="center"  colspan="2" width="40">外观信息采集</th>' +
        '<th align="center" colspan="2" width="40">频谱分析</th><th align="center" width="40" colspan="2">测量称重</th>' +
        ...
        '<th field="manage" formatter="authorityStatusFormatter"  align="center" width="40">状态</th>' +
        '<th field="manageAuthority" formatter="manageAuthorityFormatter" align="center" width="40">操作</th>' +
        '<th field="checking" formatter="authorityStatusFormatter" align="center" width="40">状态</th>' +
        '<th field="checkingAuthority" formatter="checkingAuthorityFormatter" align="center" width="40">操作</th>' +
        '<th field="numbering" formatter="authorityStatusFormatter"  align="center" width="40">状态</th>' +
        '<th field="numberingAuthority" formatter="numberingAuthorityFormatter" align="center" width="40">操作</th>' +
        '<th field="analyzing" formatter="authorityStatusFormatter" align="center" width="40">状态</th>' +
        '<th field="analyzingAuthority" formatter="analyzingAuthorityFormatter" align="center" width="40">操作</th>' +
        '<th field="measuring" formatter="authorityStatusFormatter" align="center" width="40">状态</th>' +
        '<th field="measuringAuthority" formatter="measuringAuthorityFormatter" align="center" width="40">操作</th>' +
        '<th field="photographing" formatter="authorityStatusFormatter"  align="center" width="40">状态</th>' +
        '<th field="photographingAuthority" formatter="photographingAuthorityFormatter" align="center" width="40">操作</th>' +
        '</tr>' +
        '</thead>' +
        '</table>' +
        '<div id="workGridToolBarAuthority">' +
        '<a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="javascript:$(\'#workGridAuthority\').datagrid(\'reload\')">刷新</a>' +
        '</div>' +
        '<script type="text/javascript">function initPagination(){$(\'#workGridAuthority\').datagrid(\'getPager\').pagination({layout:[\'prev\', \'sep\', \'links\', \'sep\', \'next\'], displayMsg:\'当前显示第 {from} 条到第 {to} 条记录 共 {total} 条记录\'});}</script>';
