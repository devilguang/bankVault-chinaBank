# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-09-06 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.BooleanField(default=False)),
                ('close_stautus', models.BooleanField(default=False)),
                ...
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gsinfo.gsCase')),
            ],
        ),
        migrations.CreateModel(
            name='gsSubBox',
        ...
        migrations.AddField(
            model_name='gscase',
            name='subBox',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gsinfo.gsSubBox'),
        ),
        migrations.AddField(
            model_name='gscase',
            name='work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gsinfo.gsWork'),
        ),
        migrations.AddField(
