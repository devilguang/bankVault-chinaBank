    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closePerson', models.CharField(max_length=255, null=True, verbose_name=b'\xe5\xb0\x81\xe8\xa3\x85\xe4\xba\xba')),
                ('closeCheckPerson', models.CharField(max_length=255, null=True, verbose_name=b'\xe5\xb0\x81\xe8\xa3\x85\xe5\xa4\x8d\xe6\xa0\xb8\xe4\xba\xba')),
                ('closeTime', models.DateTimeField(null=True, verbose_name=b'\xe5\xb0\x81\xe8\xa3\x85\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('casePostStatus', models.CharField(max_length=4, null=True, verbose_name=b'\xe5\x90\x91\xe4\xba\x8c\xe4\xbb\xa3\xe8\xb4\xa7\xe5\x8f\x91\xe7\xb3\xbb\xe7\xbb\x9f\xe6\x8e\xa8\xe9\x80\x81\xe6\x95\xb0\xe6\x8d\xae\xe7\x8a\xb6\xe6\x80\x81\xe7\xa0\x81')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 52000))),
            ],
        ),
        migrations.CreateModel(
            name='gsOrigBox',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('origBoxNumber', models.CharField(unique=True, max_length=255, verbose_name=b'\xe5\x8e\x9f\xe7\xae\xb1\xe5\x8f\xb7')),
                ('amount', models.PositiveIntegerField(null=True, verbose_name=b'\xe4\xbb\xb6\xe6\x95\xb0')),
                ('grossWeight', models.FloatField(null=True, verbose_name=b'\xe6\x80\xbb\xe6\xaf\x9b\xe9\x87\x8d')),
                ('status', models.BooleanField(default=False, verbose_name=b'\xe5\xb0\x81\xe7\xae\xb1\xe7\x8a\xb6\xe6\x80\x81\xef\xbc\x88False:\xe6\x9c\xaa\xe6\xb8\x85\xe5\xae\x8c; True\xef\xbc\x9a\xe5\xb7\xb2\xe6\xb8\x85\xe5\xae\x8c\xef\xbc\x89')),
            ],
        ),
        migrations.CreateModel(
            name='gsProperty',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberingCreateDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 50000))),
                ...
                ('analyzingCreateDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 50000))),
                ...
                ('measuringCreateDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 50000))),
                ...
                ('checkingCreateDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 50000))),
                ...
                ('photographingCreateDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 50000))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('serialNumber', models.CharField(unique=True, max_length=255, verbose_name=b'\xe5\xae\x9e\xe7\x89\xa9\xe6\xb5\x81\xe6\xb0\xb4\xe5\x8f\xb7')),
                ('serialNumber2', models.CharField(max_length=30, unique=True, null=True, verbose_name=b'\xe5\xae\x9e\xe7\x89\xa9\xe7\xbc\x96\xe5\x8f\xb7')),
                ...
                ('grossWeight', models.DecimalField(null=True, verbose_name=b'\xe6\xaf\x9b\xe9\x87\x8d', max_digits=20, decimal_places=3)),
                ('pureWeight', models.DecimalField(null=True, verbose_name=b'\xe7\xba\xaf\xe9\x87\x8d', max_digits=20, decimal_places=3)),
                ('originalQuantity', models.DecimalField(null=True, verbose_name=b'\xe5\x8e\x9f\xe6\xa0\x87\xe6\xb3\xa8\xe6\x88\x90\xe8\x89\xb2', max_digits=10, decimal_places=4)),
                ('detectedQuantity', models.DecimalField(null=True, verbose_name=b'\xe9\xa2\x91\xe8\xb0\xb1\xe6\xa3\x80\xe6\xb5\x8b\xe6\x88\x90\xe8\x89\xb2', max_digits=10, decimal_places=4)),
                ('amount', models.PositiveIntegerField(null=True, verbose_name=b'\xe4\xbb\xb6\xef\xbc\x88\xe6\x9e\x9a\xef\xbc\x89\xe6\x95\xb0')),
                ('length', models.DecimalField(null=True, verbose_name=b'\xe9\x95\xbf\xe5\xba\xa6', max_digits=20, decimal_places=3)),
                ('width', models.DecimalField(null=True, verbose_name=b'\xe5\xae\xbd\xe5\xba\xa6', max_digits=20, decimal_places=3)),
                ('height', models.DecimalField(null=True, verbose_name=b'\xe9\xab\x98\xe5\xba\xa6', max_digits=20, decimal_places=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createDateTime', models.DateTimeField(default=datetime.datetime(2017, 9, 27, 15, 22, 8, 46000))),
        ...
        migrations.AddField(
            model_name='gsbox',
            name='boxType',
            field=models.ForeignKey(related_name='boxType', to='gsinfo.gsProperty'),
        ),
        migrations.AddField(
            model_name='gsbox',
            name='oprateType',
            field=models.ForeignKey(related_name='oprateType', to='gsinfo.gsProperty'),
        ),
        migrations.AddField(
            model_name='gsbox',
            name='origBox',
            field=models.ForeignKey(to='gsinfo.gsOrigBox'),
        ),
    ]
