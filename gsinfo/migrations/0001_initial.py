# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-08-07 14:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measureTime', models.TimeField(null=True)),
                ('measureDate', models.DateField(null=True)),
                ('Au', models.CharField(max_length=255, null=True)),
                ('Ag', models.CharField(max_length=255, null=True)),
                ('Cu', models.CharField(max_length=255, null=True)),
                ('Pt', models.CharField(max_length=255, null=True)),
                ('Pd', models.CharField(max_length=255, null=True)),
                ('Zn', models.CharField(max_length=255, null=True)),
                ('Ni', models.CharField(max_length=255, null=True)),
                ('Cd', models.CharField(max_length=255, null=True)),
                ('Co', models.CharField(max_length=255, null=True)),
                ('Ru', models.CharField(max_length=255, null=True)),
                ('Ir', models.CharField(max_length=255, null=True)),
                ('Rh', models.CharField(max_length=255, null=True)),
                ('In', models.CharField(max_length=255, null=True)),
                ('Pb', models.CharField(max_length=255, null=True)),
                ('Fe', models.CharField(max_length=255, null=True)),
                ('Os', models.CharField(max_length=255, null=True)),
                ('W', models.CharField(max_length=255, null=True)),
                ('Others', models.CharField(max_length=255, null=True)),
                ('testUnit', models.CharField(max_length=255, null=True)),
                ('testPerson', models.CharField(max_length=255, null=True)),
                ('sampleName', models.CharField(max_length=255, null=True)),
                ('reportQuality', models.CharField(max_length=255, null=True)),
                ('testResult', models.CharField(max_length=255, null=True)),
                ('remarks', models.CharField(max_length=255, null=True)),
                ('testRequire', models.CharField(max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='gsBox',
            fields=[
                ...
                ('grossWeight', models.FloatField(null=True)),
                ('packageCapacity', models.PositiveIntegerField()),
