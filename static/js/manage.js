...
function boxManage(){
	var title = '实物管理';
	var c = '<div class="easyui-layout" data-options="fit: true"><div data-options="region:\'north\'" height="10%"><form id="boxSearchParameter" style="display:inline-block;margin-top:12px;"><div style="display:inline;margin-left:10px;margin-right:15px;"><label for="boxSearchParameter-productType" style="margin-right:5px">实物类型</label><input id="boxSearchParameter-productType" class="easyui-combobox" name="productType" data-options="valueField: \'id\', textField: \'text\', url: \'getProductType/\', editable: false, panelHeight: \'auto\', onSelect: function(rec){ var url = \'getClassName/\'+rec.id; $(\'#boxSearchParameter-className\').combobox(\'reload\', url); $(\'#boxSearchParameter-className\').combobox(\'clear\'); $(\'#boxSearchParameter-subClassName\').combobox(\'clear\');},"/></div><div style="display:inline;margin-right:15px;"><label for="boxSearchParameter-className" style="margin-right:5px;">品名</label><input id="boxSearchParameter-className" class="easyui-combobox" name="className" data-options="valueField: \'id\', textField: \'text\', editable: false, panelHeight: \'auto\', onSelect: function(rec){ var typeCode = $(\'#boxSearchParameter-productType\').combobox(\'getValue\'); var url = \'getSubClassName/\'+typeCode+\'&\'+rec.id; $(\'#boxSearchParameter-subClassName\').combobox(\'reload\', url);},"/></div><div style="display:inline;margin-right:15px;"><label for="boxSearchParameter-subClassName" style="margin-right:5px;">明细品名</label><input id="boxSearchParameter-subClassName" class="easyui-combobox" name="subClassName" data-options="valueField: \'id\', textField: \'text\', editable: false, panelHeight: \'auto\',"/></div></form><a href="javascript:void(0)" class="easyui-linkbutton" onclick="boxSearch()" style="width:60px;margin-right:10px;">查询</a><a href="javascript:void(0)" class="easyui-linkbutton" onclick="boxSearchReset()" style="width:60px;margin-right:10px;">重置</a></div><div data-options="region:\'center\'"><table id="workGridBoxManage" class="easyui-datagrid" data-options="url:\'getBox/\', queryParams: {status: 0}, toolbar:\'#workGridToolBarBoxManage\', onClickRow:ClickRow, singleSelect:true, fitColumns:true, rownumbers:true, loadMsg:\'作业数据正在载入，请稍后...\', pagination:true, fit:true, pageSize:20"><thead><tr><th field="boxNumber" align="center" width="7%">箱号</th><th field="productType" align="center">实物类型</th><th field="className" align="center">品名</th><th field="subClassName" align="center">明细品名</th><th field="wareHouse" align="center" >发行库</th><th field="amount" align="center" >件数</th><th field="operation" formatter="boxOperationFormatter" align="center" width="65%">操作</th></tr></thead></table></div></div><div id="workGridToolBarBoxManage"><a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true" onclick="javascript:$(\'#workGridBoxManage\').datagrid(\'reload\')">刷新</a><a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="openCreateBoxDlg()">新建</a><a href="#" class="easyui-linkbutton" iconCls="icon-allot" plain="true" onclick="openAllotBoxDlg()">拆箱</a><a href="#" class="easyui-linkbutton" iconCls="icon-merge" plain="true" onclick="openMergeBoxDlg()">并箱</a><a href="#" class="easyui-linkbutton" iconCls="icon-large_chart" plain="true" onclick="openReportBoxDlg()">报表</a><a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleteBox()">删除</a></div><script type="text/javascript">function initPagination(){$(\'#workGridBoxManage\').datagrid(\'getPager\').pagination({layout:[\'prev\', \'sep\', \'links\', \'sep\', \'next\'], displayMsg:\'当前显示第 {from} 条到第 {to} 条记录 共 {total} 条记录\'});}</script>';
...
function openAllotBoxDlg(){             // 打开实物拆箱
    ...
    $.post("allotBox/",{boxNumber: row.boxNumber, productType: row.productType, fromSubBox: '1', rows: '20', page: '1'},function(data){
...
function generateAbstract(index){
	$('#workGridWorkManage').datagrid('selectRow', index);workGridWorkManage
...
function deleteWork(index){
	...
	$.messager.confirm('提示', '是否确认删除“'+row.workName+'”?', function(action){
		if (action){
			...
			$.ajax({
				url: 'deleteWork/',
				data: {workName: row.workName, boxNumber: row.boxNumber, subBoxNumber: row.subBoxNumber, workSeq: row.workSeq},
				type: 'POST',
				async: true,
				dataType: 'json',
				beforeSend: function(xhr){
...
function workStartOrStop(index, status){
	$('#workGridWorkManage').datagrid('selectRow', index);
	var row = $('#workGridWorkManage').datagrid('getSelected');
	$.ajax({url: 'startOrStopWork/',
		data: {workName: row.workName, boxNumber: row.boxNumber, subBoxNumber: row.subBoxNumber, workSeq: row.workSeq, status: status},
		type: 'POST',
		async: true,
		dataType: 'json',
		success: function(result){
